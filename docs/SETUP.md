...
Detailed setup, deployment, and operations instructions. For an overview,
...
Required tools: Terraform, TFLint, Trivy, jq (used by the Cursor shell hook
and `scripts/plan.sh`), Node.js + pnpm (for `apps/web`).
